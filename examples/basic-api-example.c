...
#if 0
  /* Call 'qdpll_gc' to enforce the physical deletion of popped off
     clauses. Here, this is necessary to print only the enabled clauses by
     calling 'qdpll_print'. Calling the function 'qdpll_gc' is NOT necessary for
     the proper function of the solver. */
  qdpll_gc (depqbf);
  qdpll_print (depqbf, stdout);
#endif
